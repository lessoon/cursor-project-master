...
Guidelines:
- Title should start with an action verb (Build, Create, Implement, Design, etc.)
- Summary should be concise and clear
- Description should explain the what, why, and basic how
- Checklist should have 3-6 specific, actionable steps
- Labels should be 1-2 relevant technology/category tags
